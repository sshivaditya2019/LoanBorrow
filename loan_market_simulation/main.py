...
def plot_results(history):
    ...
    ax1_twin = ax1.twinx()
    ax1_twin.plot(time_steps, history['economic_cycle'], label='Economic Cycle', color='red', linestyle='--', alpha=0.4)
    ...
    ax2_twin = ax2.twinx()
    ax2_twin.plot(time_steps, history['economic_cycle'], label='Economic Cycle', color='red', linestyle='--', alpha=0.4)
    ...
    ax3_twin = ax3.twinx()
    ax3_twin.plot(time_steps, history['economic_cycle'], label='Economic Cycle', color='red', linestyle='--', alpha=0.4)
    ...
    ax4_twin = ax4.twinx()
    ax4_twin.plot(time_steps, history['economic_cycle'], label='Economic Cycle', color='red', linestyle='--', alpha=0.4)
    ...
    ax5_twin = ax5.twinx()
    ax5_twin.plot(time_steps, history['economic_cycle'], label='Economic Cycle', color='red', linestyle='--', alpha=0.4)
    ...
    ax6_twin = ax6.twinx()
    ax6_twin.plot(time_steps, history['economic_cycle'], label='Economic Cycle', color='red', linestyle='--', alpha=0.4)
