...
class Loan:
    ...
    def make_payment(self):
        if self.is_active:
            ...
            if self.borrower.make_payment(self):
                ...
                # longer history is a good thing, shorter history is a bad thing
                # Yun added to update the length of credit history
                self.borrower.update_credit_length(1)
    ...
    def risk_score(self):
        ...
        risk_score = (dti_ratio * 0.3 + payment_history * 0.3 +
                      credit_score_factor * 0.2 + term_factor * 0.2)
